...
# Learn MakerDAO Lingo With Our New Glossary
...
Either way, the community's got you covered with our handy new [Glossary](https://community-development.makerdao.com/en/learn/Glossary).
...
- A process in which the Maker Protocol sells a fixed amount Dai in the system for MKR that is then burned to reduce its total supply. Also known as a "Surplus Auction."
    -  [https://auctions.makerdao.com/flap](https://auctions.makerdao.com/flap)
